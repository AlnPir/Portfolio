  ...
  <v-container>
    ...
    <v-row fluid>
      <v-card
        ...
        max-width="320"
        shaped
        v-for="(project, key) in items"
        :key="`project-${key}`"
      >
        <v-img src="@/assets/img/bg-nav.webp" height="200px"></v-img>
        ...
        <v-card-subtitle>{{ $t(project.desc) }}</v-card-subtitle>

        <v-card-actions>
          <DialogProject :dialog="project.dialog"></DialogProject>
        </v-card-actions>
      </v-card>
    </v-row>
  </v-container>
      ...
      items: [
        {
          ...
          repository: "https://github.com/AlnPir/DevOps-Pipeline",
          status: "5%",
          dialog: {
            title: "projects.devops_pipeline.title",
        ...
        },
        {
          ...
          dialog: {
            ...
            technical_details: "projects.microshop.dialog.technical_details",
            skills: [
              {
                text: "Frontend",
                items: [
        ...
        },
        {
          ...
          dialog: {
            ...
            technical_details: "projects.cv.dialog.technical_details",
            skills: [
              {
                text: "Frontend",
                items: [
